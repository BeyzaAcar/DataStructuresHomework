...
/**
 * Main class for scenario 3 (test case1 + test case2 + test case3)
 * @author BeyzaAcar
 */
public class TestClass3 {
    public static void main(String[] args) {
        System.out.println("SCENARIO 3");
        System.out.println("STARTS FROM SCENARIO 1");
        ...
        System.out.println("\n*******************************************************\n");
        System.out.println("CONTINUE FROM HERE FOR SCENARIO 2");
        System.out.println("\n*******************************************************\n");
        ...
        try {
            gokhan.commentPost(5, post4, "Nice!");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        System.out.println("\n*******************************************************\n");
        System.out.println("CONTINUE FROM HERE FOR SCENARIO 3");
        System.out.println("\n*******************************************************\n");
        ...
        Message message3 = new Message(3, "sibelgulmez", "gizemsungu", "Hi");
        try {
            sibel.addMessageToOutbox(message3, gizem);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
