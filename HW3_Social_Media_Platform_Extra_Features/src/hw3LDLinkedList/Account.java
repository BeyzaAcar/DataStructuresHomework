...
public class Account
{
    ...
    private LDLinkedList<Account> followings; //this indicates the accounts following by this user.
    private LDLinkedList<Account> followers; // this indicates the accounts following this user.
    private LDLinkedList<Account> blockedAccounts;
    private LDLinkedList<String> actions;
    ...
    public void addPost(Post postToAdd) throws Exception
    {
        ...
        posts.add(postToAdd);
        actions.add("You add a post. PostID : " + postToAdd.getPostId());
    }
    ...
    public void follow(Account toFollow /* (Variable of "toFollow" is the account to follow*/) throws Exception
    {
        ...
        actions.add("An account named " + toFollow.getUsername() +  " has been followed...");
    }
    ...
    public void unfollow(Account toUnfollow ) throws Exception
    {
        ...
        actions.add("An account named " + toUnfollow.getUsername() +  " has been unfollowed...");
    }
    ...
    {
        followers.add(followRequest);
        actions.add("An account named " + followRequest.getUsername() + " followed you");
    }
    ...
    public void removeFollowers(Account unfollowRequest)
    {
        ...
        actions.add("An account named " + unfollowRequest.getUsername() + " unfollowed you");
    }
    ...
    public void likePost(Post post, Like like) throws Exception
    {
        if(!isOpen) {throw new Exception("You are not logged in");}
        post.addLike(like);
        actions.add("You liked a post. PostID : " + post.getPostId());
    }
    ...
    public void unlikePost(Post post, Like like) throws Exception
    {
        ...
        post.unlike(like);
        actions.add("You unliked a post belongs to " + post.getUsername() + " PostID : " + post.getPostId());
    }
    ...
    public void commentPost(Post post , Comment comment) throws Exception
    {
        ...
        actions.add("You commented a post. Post id : " + post.getPostId());
    }
    ...
    public void uncommentPost(Post post , Comment comment) throws Exception
    {
        ...
        actions.add("You uncommented a post. Post id : " + post.getPostId());
    }
    ...
    private void addMessageToInbox(Message message)
    {
        ...
        actions.add("You recieved a message from " + message.getSenderUserName());
    }
    ...
    public void addMessageToOutbox(Message message, Account toWho) throws Exception
    {
        ...
        {
            if(followings == null) System.out.println( "burdayimmm");
        ...
        actions.add("You sent a message to " + message.getReceiverUserName());
    }
    ...
    public void block(Account accountToBlock) throws Exception
    {
        ...
        actions.add("You blocked " + accountToBlock.getUsername());
    }
    ...
    public void unblock(Account toUnblock) throws Exception
    {
        ...
        actions.add("You unblocked " + toUnblock.getUsername());
    }
