...
public class Account
{
    ...
    private ArrayList<Account> followings; //this indicates the accounts following by this user.
    private ArrayList<Account> followers; // this indicates the accounts following this user.
    ...
    public Account(int accountId, String username, String birthdate, String location)
    {
        ...
        this.followings = new ArrayList<Account>();
